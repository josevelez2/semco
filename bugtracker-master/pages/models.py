...
class Empleado(models.Model):
    ...
    genero = models.CharField(max_length=20, choices=[('masculino', 'Masculino'), ('femenino', 'Femenino'), ('otros', 'Otros')])
    ...
    nombre_estudio = models.CharField(max_length=100, null=True, blank=True)
    ...
    persona_a_la_que_depende = models.ForeignKey('self', on_delete=models.SET_NULL, null=True, blank=True, related_name='empleados_subordinados'),
    documentos_de_ingreso = models.FileField(upload_to='documentos_de_ingreso/', blank=True)  
    de_quien_depende = models.ForeignKey('self', on_delete=models.SET_NULL, null=True, blank=True, related_name='empleados_subordinados')
